...
public class ParcelMachine {
    // Originaalandmetes on kõik suure tähega: ZIP, NAME, TYPE
    // siin peab algama muutuja väikse tähega: getZip() getName()  setName()
    // ehk konverditakse muutuja väikse algustähega algama, aga kuna JSONist tuleb
    // esimene täht suure tähega, siis JsonProperty sees öeldakse, kuidas tegelikult tuleb
